...
contract DeployAndUpgradeTest is StdCheats, Test {
    ...
    function testUpgradeWorks() public {
        ...
        assertEq(expectedValue, BoxV2(proxy).version()); // BoxV2(proxy).version() means that on the proxy address, which originally pointed to boxv1, its now pointing to boxv2
        //assertEq(expectedValue, box2.version());
